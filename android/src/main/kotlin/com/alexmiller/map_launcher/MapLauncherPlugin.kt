...
private enum class MapType { seznamMapy, google, googleGo, amap, baidu, waze, yandexNavi, yandexMaps, citymapper, mapswithme, osmand, osmandplus, doubleGis, tencent, here, petal }
...
class MapLauncherPlugin : FlutterPlugin, MethodCallHandler {
    ...
    private val maps = listOf(
            MapModel(MapType.seznamMapy, "Seznam Mapy", "cz.seznam.mapy"),
